...
class CajaFormEdit extends StatefulWidget {
  CajaModelo modelA;

  CajaFormEdit({required this.modelA}) : super();

  @override
  _CajaFormEditState createState() => _CajaFormEditState(modelA: modelA);
}

class _CajaFormEditState extends State<CajaFormEdit> {
  CajaModelo modelA;
  _CajaFormEditState({required this.modelA}) : super();
  ...
  void initState() {
    ...
    print("ver: ${listaTipo.map((item) => item['display']).toList()}");
  }
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    _buildDatoLista(
                        capturaMovimiento,
                        _movimiento = modelA.movimiento,
                        "Tipo Mov.:",
                        listaTipo),
                    _buildDatoFecha(capturaFecha, "Fecha"),
                    _buildDatoCadena(capturaGlosa, modelA.glosa, "Glosa:"),
                    _buildDatoCadena(
                        capturaCantidad, modelA.cantidad, "Cantidad:"),
                    _buildDatoCadena(capturaPrecio, modelA.precio, "Precio:"),
                    _buildDatoCadena(
                        capturaSubTotal, modelA.subtotal, "Subtotal:"),
                    _buildDatoLista(capturaCuenta, _cuenta = modelA.cuenta,
                        "Cuenta:", listaCuenta),
                    _buildDatoLista(capturaUnidad, _unidad = modelA.unidad,
                        "Unidad:", listaEva),
                    Padding(
